...
<td id="ClickedPage">&nbsp;&nbsp;[<%=i+1 %>]</td>   
 <% }}%> 
<logic:present name="portlet.tag.next"><td id="footPage"><a href="<bean:write name="portlet.tag.next"/>" target="_self">&nbsp;&nbsp;下一页</a></td></logic:present><logic:present name="portlet.tag.last"><td><a href="<bean:write name="portlet.tag.last"/>" target="_self">&nbsp;&nbsp;末页</a></td></logic:present></tr></table>
