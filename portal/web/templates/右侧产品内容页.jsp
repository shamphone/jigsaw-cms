...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="567" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td class="subtitle" height="25"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
		...
		<fulong:portlet id="st_nf1" type="simple_text">
		 ...
		 -->
                发布日期： </td>
              <td width="27%" align="left"><fulong:portlet id="field_time" type="field"></fulong:portlet>
              </td>
              <td width="43%"><!--
      ...
      <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="relativetable" style="display:none;">
        <tr>
          <td>
	  ...
	  <TABLE width=100% border=0 cellPadding=3 cellSpacing=0 style="margin-top:5px ">
          ...
          <TR>
            <TD vAlign=top align=center width=120><fulong:portlet id="field_pic" type="field"></fulong:portlet> <BR>
        浏览次数：<fulong:portlet id="content_counter" type="counter"></fulong:portlet> </TD>
            <TD width=3></TD>
            <TD vAlign=top width=450><p><B><FONT 
            color=#00008b><fulong:portlet id="field_title" type="field"></fulong:portlet></FONT></B></p>
			  <p><fulong:portlet id="field_content" type="field"></fulong:portlet></p></TD>
          </TR>         
      </TABLE>
	  </td>
  </tr>
