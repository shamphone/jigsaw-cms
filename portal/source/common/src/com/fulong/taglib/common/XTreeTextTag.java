...
public class XTreeTextTag extends BodyTagSupport {

	private static final long serialVersionUID = 4900995580124529441L;

	public int doEndTag() throws JspException {
		XTreeTag xtreeTag = (XTreeTag) this.pageContext
				.getAttribute(XTreeTag.XTREE_TAG);
		if (xtreeTag != null) {
			xtreeTag.setSText(bodyContent.getString().trim());
		}
		return EVAL_PAGE;
	}
