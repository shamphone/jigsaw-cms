...
public class XTreeActionTag extends BodyTagSupport {

	private static final long serialVersionUID = 1497843910667379688L;

	public int doEndTag() throws JspException {
		XTreeTag xtreeTag = (XTreeTag) this.pageContext
				.getAttribute(XTreeTag.XTREE_TAG);
		if (xtreeTag != null) {
			xtreeTag.setSAction(bodyContent.getString().trim());
		}
		return EVAL_PAGE;
	}
