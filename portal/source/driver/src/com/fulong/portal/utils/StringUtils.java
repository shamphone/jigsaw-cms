...
/**
 ** <CODE>StringUtils</CODE> hosts a couple of utility methods around strings.
 **/
...
public class StringUtils {
	...
	/**
	 ** Returns the name of the package of the specified class. The package will
	 * not include the common (short) name of the class or the file extension.
	 ** 
	 ** @param aClass
	 **            a class object
	 ** 
