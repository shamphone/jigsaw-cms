 ...
 *
 */
public class XMLFormalParameters implements Parameters {
	
	private Element element;
	private Document document ;
	public XMLFormalParameters(Element element){
	...
	private void addParameter(String name, String[] values) {
		Element param = null;
		NodeList nodes = element.getElementsByTagName("FormalParameter");
		...
		if (param == null) {
			param = document.createElement("FormalParameter");
	...
	private void removeParameter(String name) {
		NodeList nodes = DomUtils.getElements(this.element, "FormalParameters/FormalParameter");
		if (nodes == null)
			return;
