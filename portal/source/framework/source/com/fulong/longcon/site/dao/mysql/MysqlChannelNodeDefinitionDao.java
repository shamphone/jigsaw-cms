...
public class MysqlChannelNodeDefinitionDao extends JdbcDao implements
		ChannelNodeDefinitionDao {
	private static final Log log = LogFactory.getLog(MysqlChannelNodeDefinitionDao.class);

	private static String SQL_DELETE = "delete from channel_nodedefinition  where template_id=? and node_definition_id=?";
	...
	private String SQL_DELETE_ALL="delete from channel_nodedefinition  where template_id=? and channel_id=?";
