...
public class OracleClickCountDao extends JdbcDao implements ClickCountDao {
	private static final String SQL_INSERT = "insert into clickcount(SUMVALUE, NAME) values (?, ?)";
	...
	private static final String SQL_SELECT = "SELECT sumvalue FROM clickcount WHERE name=?";
	...
	private static final String SQL_UPDATE = "UPDATE clickcount SET sumvalue=? where name=? ";
