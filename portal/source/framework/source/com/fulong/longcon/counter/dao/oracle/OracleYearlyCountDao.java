...
public class OracleYearlyCountDao extends JdbcDao implements YearlyCountDao {
	private static final String SQL_SELECT = "SELECT sumvalue FROM YEARLY_COUNT WHERE name=? and ACCESS_YEAR = ?";
