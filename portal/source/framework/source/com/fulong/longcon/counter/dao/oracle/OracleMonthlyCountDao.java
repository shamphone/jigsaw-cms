...
public class OracleMonthlyCountDao extends JdbcDao implements MonthlyCountDao {
	private static final String SQL_SELECT = "SELECT sumvalue FROM MONTHLY_COUNT WHERE NAME=? and ACCESS_MONTH=? and ACCESS_YEAR=?";

	@Override
	public long loadCount(String name, int accessMonth, int accessYear)
			throws SQLException {
