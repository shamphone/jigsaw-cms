 ...
 * @version 1.0
 */
public class OracleDiaryCountDao extends JdbcDao implements DiaryCountDao {
	 ...
	 * @return long
	 */
	private static final String SQL_SELECT = "SELECT sumvalue FROM diary_count WHERE name=? and access_date =?";
	 ...
	 *            long
	 */
	private static final String SQL_UPDATE = "UPDATE diary_count SET sumvalue=? where name=?  and access_date =?";

	public void saveCount(String name, long newValue, Date accessTime)
			throws SQLException {
		PreparedStatement statement = null;
		try {
	 ...
	 *            String
	 */
	private static final String SQL_INSERT = "insert into diary_count(SUMVALUE, NAME,access_date) values (?, ?,?)";
