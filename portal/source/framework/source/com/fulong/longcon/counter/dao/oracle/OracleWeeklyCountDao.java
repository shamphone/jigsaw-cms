...
public class OracleWeeklyCountDao extends JdbcDao implements WeeklyCountDao {
	private static final String SQL_SELECT = "SELECT sumvalue FROM WEEKLY_COUNT WHERE name=? and ACCESS_WEEK=? and ACCESS_YEAR = ?";

	@Override
	public long loadCount(String name, long accessWeek, long accessYear)
			throws SQLException {
