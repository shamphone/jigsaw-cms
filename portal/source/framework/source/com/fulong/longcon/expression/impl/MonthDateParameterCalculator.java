 ...
 * @version 3.1
 */
public class MonthDateParameterCalculator extends BasicCalculator {
	...
	public Value calc(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			dateString = "monthPt" + dateString;
			return this.repository.getValueFactory().createValue(dateString);
		}catch(Exception e){
			return this.repository.getValueFactory().createValue("monthPt" + dateFormat.format(new Date()));
		}
	}
