 ...
 * @version 1.0
 */
public class TestClobValueDao extends DaoTestCase {
    private ClobValueDao clobValueDao = null;

    protected void setUp() throws Exception {
        super.setUp();
        clobValueDao = (ClobValueDao)this.factory.getDao(ClobValueDao.class);
    }
    ...
    public void testDelete() throws SQLException {
        ...
        clobValueDao.insert(contentID, property, index, value);
        String[] actualReturn = clobValueDao.load(contentID, property);
        assertEquals("return value", value, actualReturn[0]);

        clobValueDao.delete(contentID,property);
        actualReturn = clobValueDao.load(contentID, property);
