		...
		<tr>
			...
			<table>
				<tr>
					<td>本分类的引用属性<td>
					<td>
						<input type="hidden" name="RefPro" />
					    <input type="text" name="RefProName" readonly="readonly"  style="width: 150px;"/>
					</td>
					<td>
						<button type="button" onclick="selectProperty(definitionID,document.getElementById('RefPro'),document.getElementById('RefProName'))">选择...</button>
					</td>
				</tr>
				<tr>
					<td>属性所引用的分类<td>
