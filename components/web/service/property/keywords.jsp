...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			...
			<td>内容存储分类<td>
			<td>
				<input type="hidden" name="contentDef" />
			    <input type="text" name="contentDefName" readonly="readonly" />
				</td>
				<td>
			<button type="button" onclick="selectCategory(document.getElementById('contentDef'),document.getElementById('contentDefName'))">选择...</button>
			</td>
			</tr>
			<tr>
			<td>关键字属性<td>
			<td>
				<input type="hidden" name="keywordsProp" />
			    <input type="text" name="keywordsPropName" readonly="readonly" />
				</td>
				<td>
			<button type="button" onclick="selectProperty(document.getElementById('contentDef').value,document.getElementById('keywordsProp'),document.getElementById('keywordsPropName'))">选择...</button>
			</td>
			</tr>
				<tr>
			<td>关键字存储分类<td>
			<td>
				<input type="hidden" name="dictDef" />
			    <input type="text" name="dictDefName" readonly="readonly" />
				</td>
				<td>
			<button type="button" onclick="selectCategory(document.getElementById('dictDef'),document.getElementById('dictDefName'))">选择...</button>
			</td>
			</tr>
			<tr>
			<td>关键字显示属性<td>
			<td>
				<input type="hidden" name="dictDisplayProp" />
			    <input type="text" name="dictDisplayPropName" readonly="readonly" />
				</td>
				<td>
			<button type="button" onclick="selectProperty(document.getElementById('dictDef').value,document.getElementById('dictDisplayProp'),document.getElementById('dictDisplayPropName'))">选择...</button>
			</td>
			</tr>
			</table>
				</div>
