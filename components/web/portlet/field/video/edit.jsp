        ...
        <fieldset style="display:none">
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
            <tr>
              ...
              <td class="formComponent">
                <html:select property="preference(uiMode)">
                  <html:option value="full">完整</html:option>
                  <html:option value="mini">精简</html:option>
                  <html:option value="none">无</html:option>
                  <html:option value="invisible">不显示</html:option>
                </html:select>
              </td>
            </tr>
            <tr>
              <td class="formTitle">播放次数</td>
              <td class="formComponent"><html:text property="preference(playCount)" onblur="validatorInteger(this)"/></td>
            </tr>
            <tr>
              <td class="formTitle">音量</td>
              <td class="formComponent"><html:text property="preference(volume)" onblur="validatorInteger(this)"/></td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="formComponent">
                <html:checkbox style="width:25px" property="preference(autoStart)">自动播放</html:checkbox>
              </td>
              <td class="formComponent">
                <html:checkbox style="width:25px" property="preference(stretchToFit)">按比例伸展</html:checkbox>
              </td>
            </tr>
            <tr>
              <td class="formComponent">
                <html:checkbox style="width:25px" property="preference(fullScreen)">全屏</html:checkbox>
              </td>
              <td class="formComponent">
                <html:checkbox style="width:25px" property="preference(windowlessVideo)">无窗口视频</html:checkbox>
              </td>
            </tr>
         </table>
        </fieldset>
