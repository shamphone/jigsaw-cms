            ...
            <tr>
              ...
              <tr>
                ...
                <td class="formComponent" valign="top">
                  ...
                  <button type="button" class="commonbut" id="search" onclick="searchPropertyDefinition(form.elements['preference(category)'],form.elements['preference(field)'],form.elements['fieldName'],['0','1','2','5','6','7','8','9','10'])">选择...</button>
                </td>
              </tr>
              <tr>
                <td class="formTitle">数据格式</td>
                <td class="formComponent">
                  <html:select property="preference(numberFormats)" style="width:210px">
                    <html:option value="">缺省</html:option>
                    <bean:define id="numberMap" name="numberFormats" type="java.util.Map"/>
                    <logic:iterate id="key" name="numberFormatKeys" type="String">
                      <html:option value="<%=key %>"><%=numberMap.get(key) %></html:option>
                    </logic:iterate>
                    <html:option value="###,000.######################################">123,456</html:option>
                  </html:select>
                </td>
              </tr>
              <tr>
