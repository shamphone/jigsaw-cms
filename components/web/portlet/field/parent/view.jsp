...
<ul id="<bean:write name='javax.portlet.id'/>" class="<bean:write name="preferences" property="value(table-style)" ignore="true"/>">
<li><site:insert page='<%= path +"?javax.portlet.page.mode=view&definition="+ definitionId %>' contextName="<%= contextName %>" flush="false"></site:insert></li>
</ul>
