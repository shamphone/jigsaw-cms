...
<script type="text/javascript" language="javascript">
  	window.onload = function(){
          	...
          	var fckDocument = window.dialogArguments.FCKDocument;
      	  	if(fckDocument!=null){
      	  	  	var root = fckDocument.documentElement.cloneNode(true);
      	  		var portlets=root.all.tags("DIV");
            ...
            <td class="pannelDiv" rowspan="2">
                ...
                <td><fieldset>
                    <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
                    	...
                    	<tr>
                        	<td class="formTitle">标题高度</td>
                        	<td class="formComponent">
                            	<html:text property="preference(title_height)" style="width:194px;"/>
                        	</td>
                    	</tr>
                    	 <tr>
                        	<td class="formTitle">变幻延迟时间</td>
                        	<td class="formComponent">
                            	<html:text property="preference(time)" style="width:194px;" onblur="validatorInteger(this)"/>&nbsp;&nbsp;秒
                        	</td>
                    	</tr>
                    	<tr>
                        	<td class="formTitle">图片替换速度</td>
                        	<td class="formComponent">
                            	<html:text property="preference(speed)" style="width:194px;" onblur="validatorInteger(this)"/>
                        	</td>
                    	</tr>  
                </table>
            </fieldset>
