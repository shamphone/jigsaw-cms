		...
		window.onload = function(){
          	...
          	var fckDocument = window.parent.dialogArguments.FCKDocument;
                ...
                for(var i=0;i<portlets.length;i++){
                    if((portlets[i].className=='portletWindow') && ((portlets[i].getAttribute("type")=='field')||(portlets[i].getAttribute("type")=='numeral'))){
            ...
            <td class="pannelDiv" rowspan="2">
                ...
                <td><fieldset>
                    <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
                    	...
                    	<tr>
	                        <td class="formTitle">字体</td>
	                        <td class="formComponent">
	                            <html:select property="preference(name)" style="width:200px;">
	                            	<html:options name="fonts"/>
	                        	</html:select>
	                    	</td>
                   		</tr>
                    	<tr>
                        	<td class="formTitle">字符宽度(磅)</td>
                        	<td class="formComponent">
                            	<html:text property="preference(charWidth)" style="width:194px;" onblur="validatorInteger(this)"/>
                        	</td>
                    	</tr>
                </table>
            </fieldset>
