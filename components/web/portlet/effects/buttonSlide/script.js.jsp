...
sas.ued.PlayerVersion=function(arrVersion){
	this.major=parseInt(arrVersion[0])||0;this.minor=parseInt(arrVersion[1])||0;
...
function Cookie(document,name,hours,path,domain,secure){
	...
	this.$path=path?path:null;this.$domain=domain?domain:null;this.$secure=secure;
};
