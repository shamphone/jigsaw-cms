...
<%
  ...
  <li><input type="file" <logic:notEmpty name="preferences" property="value(size)">size="<bean:write name="preferences" property="value(size)"/>"</logic:notEmpty> name="<bean:write name="preferences" property="value(propertyId)" ignore="true"/>" <logic:notEmpty name="preferences" property="value(fileStyle)">class="<bean:write name="preferences" property="value(fileStyle)"/>"</logic:notEmpty> /></li>
<%} %>
</ul>
