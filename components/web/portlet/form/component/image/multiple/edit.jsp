      ...
      <td>
          ...
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
            <tr>
              ...
              <td class="formComponent">
                ...
                <input type="text" id="fieldName" readonly="readonly" value="<logic:present name="property"><bean:write name="property" property="name" ignore="true"/></logic:present><logic:notPresent name="property"><bean:write name="propertyDeleted" ignore="true"/></logic:notPresent>" />
            ...
            <tr>
              ...
              <td class="formComponent">
                <html:text property="preference(previewStyle)"/>
              </td>
            </tr>
            <tr>
        ...
        <fieldset style="display:none; ">
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
            ...
            <tr>
              <td class="formTitle">没有图片显示时的默认图片</td>
              <td class="formComponent">
