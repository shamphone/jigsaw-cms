      ...
      <td>
        <fieldset>
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
            ...
            <tr>
              <td class="formTitle">宽</td>
              <td class="formComponent"><html:text property="preference(width)" onblur="validatorInteger(this)"/> </td>
            </tr>
            <tr>
              <td class="formTitle">高</td>
              <td class="formComponent"><html:text property="preference(height)" onblur="validatorInteger(this)"/> </td>
            </tr>
            <tr>
              <td class="formTitle">&nbsp;</td>
              <td class="formComponent">
              	   <html:checkbox styleId="Toolbars" property="preference(Toolbars)" ><label for="Toolbars">显示工具栏</label></html:checkbox>
              	   <html:checkbox styleId="Menubar" property="preference(Menubar)" ><label for="Menubar">显示菜单</label></html:checkbox>
              </td>
            </tr>
            <tr>
...
<script type="text/javascript" language="javascript">
  ...
  */
  function searchPropertyDefinition($categoryId){
    var arr = CMSDialog.PropertyDefinitionSelector($categoryId,null,["8"]);
    if(arr!=null){
