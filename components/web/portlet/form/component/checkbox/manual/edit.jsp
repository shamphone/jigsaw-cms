        ...
        <fieldset>
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
            ...
            <tr>
              ...
              <td class="formComponent">
                <input type="text" name="preference(label)" value="<bean:write name='preferences' property='value(label)' filter='false'/>"/> <button type="button" class="commonbut" onclick="advancedText(this.form.elements['preference(label)'])">高级...</button>
              </td>
            </tr>
            <tr>
