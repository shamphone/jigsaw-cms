...
var CopyPortlet = {
      copy : function(oForm,formURL,categories,bChoose,buttonName){
    if(checkNull(oForm.elements['node'])){
    	var ids = '';
    	  if(bChoose){
    		  var arr = CMSDialog.NodeDefinitionSelector('no-properties-scheme',categories,false,'true',true);
    		  if (arr != null) {
     ...
     singleCopy: function(formURL,categories,bChoose,buttonName){
	  var ids = '';
  	  if(bChoose){
