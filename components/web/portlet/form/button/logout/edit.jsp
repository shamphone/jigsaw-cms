    ...
    <portlet:form action="save" method="POST">
        <tr>
            ...
            <fieldset style="display:none">
                ...
                <div class="toolbar">
          		<button type="button" onclick="validatorRequired(new Array(form.elements['preference(channel)']),new Array('登出后导航到'),this.form)">保存</button>
