<%@page contentType="text/html; charset=UTF-8"%><%@taglib
	...
	<pt:param name="portlet_action_name">recommendNode</pt:param>
</pt:actionURL>
...
<button type="button"
	...
	onclick="RecommandPortlet.recommand(this.form,'<%=formURL%>',categories<bean:write name='javax.portlet.id'/>,<bean:write name="preferences" property="value(choose)"/>,'<bean:write name="preferences" property="value(value)" />')"
