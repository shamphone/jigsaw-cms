        ...
        <td>
          <fieldset>
            <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
              ...
              <tr style="border:1px #FF0099 solid">
            ...
            <fieldset style="display:none">
              <table width="100%" cellpadding="2" cellspacing="2" border="0">
                <tr>
                  ...
                  <td nowrap="nowrap">列数</td>
                  <td><html:text property="preference(column)" size="8" onblur="validatorInteger(this)"/></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>无结果文字</td>
                  <td colspan="3"><html:text  property="preference(noContentWord)" size="30"/>
                  </td>
                </tr>
                <tr>
                  <td>无结果样式</td>
              ...
              <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
                <tr>
                  ...
                  <html:hidden property="preference(contextName)"/>
          			<!-- <button type="button" onclick="editClipFile(form.elements['preference(clip-content)'],form.elements['preference(clip-view)'],form.elements['preference(category)'],document.getElementById('oViewDiv'),'<bean:write name="formDefinition" ignore="true"/>',window.parent.dialogArguments.channel,window.parent.dialogArguments.styleSheets)">修改...</button> -->
