...
<script type="text/javascript" language="javascript">
	...
	<logic:present name="properties">
  	...
  	window.onload = function() {
  	  	var fm = window.parent.parent.dialogArguments.form;
      	if (fm) {
                ...
                <td><fieldset>
                    <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
                        ...
                        <tr>
                            ...
                            <td class="formComponent">
                                <html:select property="preference(op)">
                                <html:option value="FieldLess">小于</html:option>
                                <html:option value="FieldEquals">等于</html:option>
                                <html:option value="FieldGreater">大于</html:option>
                            </html:select>
                        </td>
                    </tr>
                        <tr>
                            <td class="formTitle">另一控件</td>
                            <td class="formComponent">
                                <html:select  property="preference(another)">
