    ...
    <tr>
      <td class="pannelDiv">
        <select id="pannelSelect" name="pannelSelect" onchange="selectPanel(this)" size="10">
          ...
          <option value="2">重复内容</option>
        </select></td>
        <td>
          <fieldset>
            <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
              <tr>
                <td class="formTitle">初始日期</td>
                <td class="formComponent">
                  <html:select property="preference(initialDate)" style="width:83px">
                     <html:option value="today">当天</html:option>
                     <html:option value="monday">周一</html:option>
                  </html:select>
                 </td>
              </tr>
              <tr>
              ...
              <html:hidden property="preference(contextName)"/>
                <tr>
                  ...
                  <td class="formComponent" width="80%"><bean:parameter id="formDefinition" name="formDefinition" value="" />
          			<button type="button" onclick="editClipFile('<bean:write name="path"/>',form.elements['preference(category)'],document.getElementById('editorFrame'),'<bean:write name="formDefinition" ignore="true"/>')">修改...</button>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
