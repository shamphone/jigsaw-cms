...
<li class="<logic:equal value="<%=ID%>" name="theChannel" property="ID"><bean:write name="preferences" property="value(page-style-selected)" ignore="true"/></logic:equal><logic:notEqual value="<%=ID%>" name="theChannel" property="ID"><bean:write name="preferences" property="value(page-style)" ignore="true"/></logic:notEqual>">
<a href="<site:channelURL name='theChannel'/>" target="<bean:write name="preferences" property="value(target)"/>"><bean:write name="theChannel" property="displayName"/></a>
</li>
</logic:iterate>
</ul>
