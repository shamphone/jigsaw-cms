...
<portlet:form action="save" method="POST" onsubmit="return submit_navigator(this)"  target="portletEditor">
  <table cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="pannelDiv" rowspan="2"><select id="pannelSelect" name="pannelSelect" onchange="selectPanel(this)" size="10">
        <option value="0" selected="selected"><bean:message key="com.fulong.site.portlet.vertical.edit.option0.channelSet" bundle="siteVertical"/></option>
        <option value="1"><bean:message key="com.fulong.site.portlet.vertical.edit.option1.styleSet" bundle="siteVertical"/></option>
      </select></td>
      <td><fieldset>
        <table cellpadding="2" cellspacing="2" border="0" class="formTable">
          <tr>
            <th align="left"><bean:message key="com.fulong.site.portlet.vertical.edit.chosenAbleChannel" bundle="siteVertical"/></th>
            <th></th>
            <th align="left"><bean:message key="com.fulong.site.portlet.vertical.edit.currentChannel" bundle="siteVertical"/></th>
          </tr>
          <tr>
      ...
      <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formTable">
        <tr>
          <td></td>
          <td class="formComponent"><html:checkbox style="width:25px" property="preference(target)" value="_blank"/><bean:message key="com.fulong.site.portlet.vertical.edit.fieldset1.openInNewWindows" bundle="siteVertical"/></td>
        </tr>
        <tr>
          <td class="formTitle"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle1.tableStyle" bundle="siteVertical"/></td>
          <td class="formComponent"><html:text property="preference(list-style)"/>
          <button type="button" onclick="doSelectStyle(this.form.elements['preference(list-style)'])"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle1.tableStyle.choose" bundle="siteVertical"/></button>
          </td>
        </tr>
        <tr>
          <td class="formTitle"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle2.channelStyle" bundle="siteVertical"/></td>
          <td class="formComponent"><html:text property="preference(page-style)"/>
          <button type="button" onclick="doSelectStyle(this.form.elements['preference(page-style)'])"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle2.channelStyle.choose" bundle="siteVertical"/></button>
          </td>
        </tr>
        <tr>
          <td class="formTitle"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle3.chosenStyle" bundle="siteVertical"/></td>
          <td class="formComponent"><html:text property="preference(page-style-selected)"/>
          <button type="button" onclick="selectStyle(this.form.elements['preference(page-style-selected)'])"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle3.chosenStyle.choose" bundle="siteVertical"/></button>
          </td>
        </tr>
        <tr>
          <td class="formTitle"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle4.separator" bundle="siteVertical"/></td>
          <td class="formComponent"><html:text property="preference(seperator)"/></td>
        </tr>
        <tr>
          <td class="formTitle"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle5.separatorStyle" bundle="siteVertical"/></td>
          <td class="formComponent"><html:text property="preference(seperator-style)"/>
          <button type="button" onclick="doSelectStyle(this.form.elements['preference(seperator-style)'])"><bean:message key="com.fulong.site.portlet.vertical.edit.formTitle5.separatorStyle.choose" bundle="siteVertical"/></button>
          </td>
        </tr>
      </table>
    </fieldset></td></tr>
