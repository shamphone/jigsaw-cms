package com.fulong.portlet.component;
...
public class PortletConfig {
	...
	public String getCategoryID() {
		String id = this.preferences.getValue("category-id", NodeDefinition.NO_PROPERTIES_SCHEME);
		if (id.length() == 0) {
			return null;
		}
		return id;
	...
	public String getPropertyId() {
		String propertyId = this.preferences.getValue("propertyId", "");
