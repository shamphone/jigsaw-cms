...
public class FinalRender extends ListContentPortletRender {
	...
	public ActionForward render(ActionMapping mapping, ActionForm form, RenderRequest request, RenderResponse response)
		...
		if(preferences.getValue("column", null)==null){
			preferences.setValue("column", "1");
		}
		
		ContentListConfig config = new ContentListConfig(preferences);
		...
		if (refField != null) {
			...
			return this.processRefField(pd, node, refField,preferences, request, mapping, config, pager);
		}
