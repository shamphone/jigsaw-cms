...
public final class messages_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  var bStop = false;\r\n");
      out.write("  var count = new Date().getTime();\r\n");
      out.write("  var timer = null;\r\n");
      out.write("function doInit(){\r\n");
      out.write("\ttimer = setInterval(loadMessages,2000); \r\n");
      out.write("}\r\n");
      out.write("function loadMessages(){\r\n");
      out.write("\tvar url =\"../messages.do?msgCode=\"+window.dialogArguments+\"&count=\"+(count++);\r\n");
      ...
      out.write("\t * bug\r\n");
      out.write("\t * 修改目的：没有返回信息\r\n");
      out.write("\t * 修改描述：/service/messages.jsp里一些空格导致req.responseXML得到一个空对象，删除/service/messages.jsp中的一些空格后正常\r\n");
      out.write("\t */\r\n");
      out.write("    var oXML = req.responseXML;\r\n");
      out.write("    var nodes = oXML.getElementsByTagName(\"message\");    \r\n");
      out.write("    for(var i=0;i<nodes.length;i++){\r\n");
      out.write("\t    var oDiv = document.createElement(\"div\");\r\n");
      out.write("\t    oDiv.noWrap= true;\r\n");
      out.write("\t    oDiv.innerHTML = nodes[i].childNodes[0].nodeValue;\r\n");
      out.write("\t    document.all(\"messages\").appendChild(oDiv);\r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      ...
      out.write("<div id=\"messages\" style=\"height: 350px;width:99%;\" class=\"insetDiv\"></div>\r\n");
      out.write("<div class=\"operation\">\r\n");
      out.write("<button type=\"button\" onclick=\"window.returnValue=true;window.close()\" class=\"commonbut\" id=\"btnOK\">重试</button>\r\n");
      out.write("<button type=\"button\" onclick=\"window.close()\" class=\"commonbut\" id=\"btnOK\">关闭</button>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_html_005frewrite_005f2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_005frewrite_005f2.setPage("/script/dialog.jsp");
