...
public final class edit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tdocument.all(\"newName\").value = ResourceEditor.folder.getName();\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\tvar oldFolder = ResourceEditor.folder;\r\n");
      out.write("\t\tvar fileName = checkFileName(oForm.newName);\r\n");
      out.write("\t\tif (fileName == null) {\r\n");
      out.write("\t\t\toForm.newName.select();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar newFolder = oldFolder.getParent().getChild(fileName);\r\n");
      out.write("\t\tif (newFolder.exists()) {\r\n");
      out.write("\t\t\talert(\"该名称已被使用，请更名后重试\");\r\n");
      out.write("\t\t\toForm.newName.select();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\toldFolder.rename(fileName);\r\n");
      out.write("\t\twindow.returnValue = oldFolder;\r\n");
