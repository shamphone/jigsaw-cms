    ...
    if (_jspx_eval_portlet_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_bean_005fwrite_005f1(_jspx_th_portlet_005fform_005f0, _jspx_page_context))
          return true;
        out.write("\" />\r\n");
        out.write("                <button class=\"commonbut\" id=\"search\" onclick=\"searchPropertyDefinition(form.elements('preference(category-id)'),form.elements('preference(propertyId)'),form.elements('fieldName'),['0','2','5','6','7','8','9'])\">选择...</button>\r\n");
        out.write("              </td>\r\n");
        out.write("            </tr>\r\n");
        out.write("            <tr>\r\n");
