...
public final class property_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"displayName\"  readonly=\"readonly\" disabled=\"disabled\"/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t<td colspan=\"3\"><input type=\"text\" name=\"definition\" />\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>字符集</td>\r\n");
      out.write("\t\t\t\t<td><input type=\"text\" name=\"content-type\" title=\"设定页面使用的字符集，用以说明主页制作所使用的文字已经语言，浏览器会根据此来调用相应的字符集显示page内容。\"  /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>关键字</td>\r\n");
