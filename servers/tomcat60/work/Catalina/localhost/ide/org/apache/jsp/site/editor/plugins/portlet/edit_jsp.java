...
public final class edit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        var param=window.parent.dialogArguments;\r\n");
      ...
      out.write("            oForm.elements[\"formDefinition\"].value=param.form.getAttribute(\"formDefinition\");\r\n");
      out.write("       // alert(\"param.form.formDefinition=\"+param.form.formDefinition+\"@@@@@@@@\"+param.form.outerHTML)\r\n");
      out.write("\t\t/*\r\n");
      out.write("         for(var i in param.form){\r\n");
      out.write("           alert(i+\"是：\"+param.form[i])\r\n");
      out.write("        }*/\r\n");
      out.write("        if(param.node!=null)\r\n");
      out.write("            oForm.elements[\"node\"].value=param.node;\r\n");
      out.write("        if(param.form){\r\n");
      out.write("          if(param.form.getAttribute(\"definition\")!=null)\r\n");
      out.write("          \toForm.elements[\"formDefinition\"].value=param.form.getAttribute(\"definition\");\r\n");
      out.write("          if(param.form.getAttribute(\"node\")!=null)\r\n");
      out.write("          oForm.elements[\"node\"].value=param.form.getAttribute(\"node\");\r\n");
      out.write("        }\r\n");
  ...
  private boolean _jspx_meth_html_005frewrite_005f0(PageContext _jspx_page_context)
    ...
    // /site/editor/plugins/portlet/edit.jsp(16,22) name = module type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005frewrite_005f0.setModule("/site/editor");
    // /site/editor/plugins/portlet/edit.jsp(16,22) name = page type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
