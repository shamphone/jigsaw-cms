...
// $Id: pgagent.sql 7525 2008-12-29 17:30:06Z dpage $
...
-- Records of pga_job
-- ----------------------------
INSERT INTO "pgagent"."pga_job" VALUES ('1', '1', 'count_job', '', '', 't', now(), now(), null, cast(now() as date)+integer '1',null);

-- ----------------------------
-- Records of pga_jobstep
-- ----------------------------
INSERT INTO "pgagent"."pga_jobstep" VALUES ('1', '1', 'count_job', '每晚零点调用统计过程的job', 't', 's', 'select pro_count_new();', '', 'newCoolink', 'f', null);

-- ----------------------------
-- Records of pga_schedule
-- ----------------------------
INSERT INTO "pgagent"."pga_schedule" VALUES ('1', '1', 'count_job', '每晚零点调用统计过程的job', 't', date_trunc('day',now()), '2020-12-31 00:00:00+08', '{t,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f}', '{t,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f}', '{t,t,t,t,t,t,t}', '{f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f}', '{f,f,f,f,f,f,f,f,f,f,f,f}');
