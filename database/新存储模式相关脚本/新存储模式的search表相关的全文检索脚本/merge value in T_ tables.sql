/**
*CATEGORY:COOLINK
*PROCEDURE:merge value in T_* tables into search table, for full text search
*CORP.:FULONG
*AUTHOR:LIULEI
*DATE:07/05/2009
*VERSION:2.2
...
declare
   CURSOR cur_tablenames is SELECT TNAME FROM TAB WHERE TABTYPE='TABLE' AND TNAME LIKE 'T\_%' escape '\';
