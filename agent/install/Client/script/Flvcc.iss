...
source: "webmanager3.0\Webmonitor\WebContent\docs\help.htm"; DestDir: "{app}\help"; Flags: ignoreversion;
source: "webmanager3.0\Webmonitor\WebContent\docs\help.files\*"; DestDir: "{app}\help\help.files"; Flags: ignoreversion;
