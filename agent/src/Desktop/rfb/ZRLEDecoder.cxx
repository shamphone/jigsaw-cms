 ...
 * USA.
 */
#include "../LyvcdesktopClient/CMsgReader.h"
#include "../LyvcdesktopClient/CMsgHandler.h"
...
ZRLEDecoder* ZRLEDecoder::create(CMsgReader* reader)
{
...
void ZRLEDecoder::readRect(const Rect& r, CMsgHandler* handler, int bpp)
{
