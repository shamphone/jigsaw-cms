...
namespace rfb {
  ...
  public:
    ...
    void init(PixelBuffer* pb, const PixelFormat& outPF, /*SMsgWriter* writer=0,*/ColourCube* cube=0);

	void init(PixelFormat in, const PixelFormat& out, /*SMsgWriter* writer=0,*/ColourCube* cube=0);
    ...
    void setColourMapEntries(int firstColour, int nColours/*,SMsgWriter* writer=0*/);
    ...
    void translatePixels1(void* inPtr, void* outPtr, int nPixels) const;
