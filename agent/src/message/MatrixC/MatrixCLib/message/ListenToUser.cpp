...
string LyvcMessage::ListenToUser::toXML()
{
	...
	xml = xml + buffer;
	xml = xml + "</receiverId>";
	xml = xml + "<beListenedIds>";
	xml = xml + BaseMessage::encodeHtmlEscape(this->beListenedIds);
	xml = xml + "</beListenedIds>";
	xml = xml + "</lyvcmessage>";
	return xml;
}

bool LyvcMessage::ListenToUser::fromXML(string& xmlString)
{
	string tagContent;
