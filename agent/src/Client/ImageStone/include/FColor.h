...
//-----------------------------------------------------------------------------
inline void FCColor::AlphaBlendPixel (BYTE* pDest, const BYTE* pSrc, BYTE nAlphaSrc)
{
    if (nAlphaSrc == 0xFF)
    {
        *(WORD*)pDest = *(WORD*)pSrc ;
...
//-----------------------------------------------------------------------------
inline RGBQUAD FCColor::__DoubleRGB_to_RGB (const double& r, const double& g, const double& b)
{
    return PCL_RGBA (FClamp0255((int)(r*255)),
                     FClamp0255((int)(g*255)),
                     FClamp0255((int)(b*255))) ;
}
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
inline bool FCColor::__IsRGBEqual (const void* p1, const void* p2)
{
