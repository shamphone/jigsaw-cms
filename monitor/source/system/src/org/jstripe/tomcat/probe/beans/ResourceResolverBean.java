...
public class ResourceResolverBean implements ResourceResolver {
    ...
    private List<Object> datasourceMappers = new ArrayList<Object>();
    ...
    public synchronized List<ApplicationResource> getApplicationResources(Context context) throws NamingException {
    ...
    public void lookupResource(ApplicationResource resource, boolean contextBound) {
        ...
        if (contextBound) {
            try {
                ...
                for (Iterator<Object> it = datasourceMappers.iterator(); it.hasNext();) {
	...
	public List<Object> getDatasourceMappers() {
        return datasourceMappers;
    }

    public void setDatasourceMappers(List<Object> datasourceMappers) {
