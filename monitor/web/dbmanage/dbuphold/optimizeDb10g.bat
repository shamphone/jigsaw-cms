...
echo.alter system set lock_sga=true scope=spfile;>>%TOMCAT_HOME%\optimizeDb.sql
echo.alter system set pre_page_sga=true scope=spfile;>>%TOMCAT_HOME%\optimizeDb.sql
