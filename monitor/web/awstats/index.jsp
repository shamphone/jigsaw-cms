...
<frameset id="main" rows="37,*" cols="*"  frameborder="0" border="1" framespacing="0">
  <frame src="../system/toolbar.jsp" name="index" rows="20"  scrolling="no" marginheight="0" marginwidth="0" scrolling="no" noresize />
  <frameset id="main2" rows="*" cols="230,*"  frameborder="1" border="1" framespacing="3">
    <frame src="left.jsp" name="left" marginheight="0" marginwidth="0" scrolling="no"/>
   	<frame src="../cgi-bin/awstats.pl?framename=mainright" name="mainright" marginheight="1" marginwidth="1" />
  </frameset>
</frameset>
</html>
