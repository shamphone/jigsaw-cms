        ...
        <ul class="options">
            ...
            <c:choose>
                <c:when test="${app.available}">
                    <li id="appStop"><a href="<c:url value="/system/probe/app/stop_summary.htm"><c:param name="webapp" value="${param.webapp}"/></c:url>"><spring:message code="probe.jsp.app.summary.menu.stop"/></a></li>
                </c:when>
                <c:otherwise>
                    <li id="appStart"><a href="<c:url value="/system/probe/app/start_summary.htm"><c:param name="webapp" value="${param.webapp}"/></c:url>"><spring:message code="probe.jsp.app.summary.menu.start"/></a></li>
                </c:otherwise>
            </c:choose>
            <li id="appReload"><a href="<c:url value="/system/probe/app/reload_summary.htm"><c:param name="webapp" value="${param.webapp}"/></c:url>"><spring:message code="probe.jsp.app.summary.menu.reload"/></a></li>
            <li id="appUndeploy"><a href="<c:url value="/system/probe/adm/undeploy_summary.htm"><c:param name="webapp" value="${param.webapp}"/></c:url>"
                ...
                <c:choose>
                    <c:when test="${app.available}">
                        <table class="statsTable" cellpadding="0" cellspacing="0" width="90%">
                            ...
                            <tr>
                                <td class="leftMost">
                                    <a href="sessions.htm?webapp=${app.name}&size=${param.size}">${app.sessionCount}</a>
                                </td>
                                <td>
                                    <c:choose>
