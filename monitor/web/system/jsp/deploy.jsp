...
<c:if test="${! empty successMessage}">
    <div id="successMessage">
        ...
        <a href="<c:url value="/system/probe/app/jsp.htm"><c:param name="webapp" value="${compiled_app}"/></c:url>"><spring:message code="probe.jsp.deployment.compilationDetails"/></a></c:if>
    </div>
</c:if>
...
<div id="deploy">
    <div id="deployScenario1" class="deploy">
        ...
        <form action="<c:url value="/system/probe/adm/war.htm"/>" method="post" enctype="multipart/form-data">
            <dl>
    ...
    <div id="deployScenario2" class="deploy">
        ...
        <form action="<c:url value="/system/probe/adm/deploycontext.htm"/>" method="get">
            <dl>
