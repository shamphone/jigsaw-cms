...
<c:choose>
    ...
    <c:otherwise>
        ...
        <c:url value="/system/probe/chart.png" var="os_memory_url">
        ...
        <c:url value="/system/probe/chart.png" var="os_memory_url_full">
            <c:param name="p" value="os_memory"/>
        ...
        <c:url value="/system/probe/chart.png" var="swap_usage_url">
        ...
        <c:url value="/system/probe/chart.png" var="swap_usage_url_full">
            <c:param name="p" value="swap_usage"/>
            <c:param name="xz" value="650"/>
            <c:param name="yz" value="320"/>
            <c:param name="s1c" value="#FFCD9B"/>
        ...
        <c:url value="/system/probe/chart.png" var="cpu_usage_url">
        ...
        <c:url value="/system/probe/chart.png" var="cpu_usage_url_full">
            <c:param name="p" value="cpu_usage"/>
            <c:param name="xz" value="650"/>
            <c:param name="yz" value="320"/>
            <c:param name="s1c" value="#FFCCCC"/>
        ...
        <script type="text/javascript">
            ...
            new Ajax.PeriodicalUpdater("osinfo", "<c:url value="/system/probe/adm/osinfo.ajax"/>", {frequency: 5});
