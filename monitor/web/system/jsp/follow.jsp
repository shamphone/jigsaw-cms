...
<ul class="options">
    <li id="back"><a href="<c:url value="index.htm"/>"><spring:message code="probe.jsp.follow.menu.back"/></a></li>
    ...
    <li id="download"><a
            href="<c:url value="download"><c:param name="id" value="${param.id}"/></c:url>"><spring:message code="probe.jsp.follow.menu.download"/></a></li>
</ul>
...
<script type="text/javascript">
    ...
    var infoUpdater = new Ajax.PeriodicalUpdater("info", "<c:url value="ff_info.ajax"/>", {frequency: 3});
    //
    // enable automatic updater of the followed file content
    //
    var updater = new Ajax.PeriodicalUpdater(file_content_div, "<c:url value="follow.ajax"/>", {frequency: 3});
    var top = -1;
    ...
    var rules = {
        ...
        '#clear': function(element) {
            element.onclick = function() {
                new Ajax.Request('<c:url value="clear.ajax"/>', {method:'get',asynchronous:true});
                new Ajax.Updater(file_content_div, "<c:url value="follow.ajax"/>");
                return false;
            }
        }
