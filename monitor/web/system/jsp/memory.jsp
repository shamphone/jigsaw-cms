...
<c:choose>
    ...
    <c:otherwise>
        ...
        <ul class="options">
            <li id="adviseGC"><a href="<c:url value="/system/probe/adm/forcegc.htm"/>"><spring:message code="probe.jsp.memory.advise.gc"/></a></li>
            <li id="adviseFin"><a href="<c:url value="/system/probe/adm/forcegc.htm?fin=true"/>"><spring:message code="probe.jsp.memory.advise.finalization"/></a></li>
        </ul>
