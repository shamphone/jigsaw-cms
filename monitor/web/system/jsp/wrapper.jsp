...
<c:choose>
    ...
    <c:otherwise>
        <ul class="options">
            <li id="thread_dump"><a href=""><spring:message code="probe.jsp.wrapper.menu.thread_dump"/></a></li>
            <li id="stop_jvm"><a href=""><spring:message code="probe.jsp.wrapper.menu.stop"/></a></li>
            <li id="restart_jvm"><a href=""><spring:message code="probe.jsp.wrapper.menu.restart"/></a></li>
        </ul>
                ...
                '#restart_jvm': function(element) {
                    element.onclick = function() {
                        return confirm("<spring:message code="probe.jsp.wrapper.confirm.restart"/>") &&
                               execute('<c:url value="/system/probe/adm/restartvm.ajax"/>');
                    }
                },
                '#stop_jvm': function(element) {
                    element.onclick = function() {
                        return confirm("<spring:message code="probe.jsp.wrapper.confirm.stop"/>") &&
                               execute('<c:url value="/system/probe/adm/stopvm.ajax"/>');
                    }
                },
                '#thread_dump': function(element) {
                    element.onclick = function() {
                        return execute('<c:url value="/system/probe/adm/threaddump.ajax"/>');
                    }
