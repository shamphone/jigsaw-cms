...
<html>
	<head>
		...
		<script type="text/javascript" src="<html:rewrite page='/script/ajax2.js'/>"></script>
		<script type="text/javascript" src="<html:rewrite page='/script/tab-view.js'/>"></script>
	...
	<script type="text/javascript">
		function getUsers() 
		{
			...
			document.location.href='create.do?groupId='+selectedGroupId+'&userId='+userId+'&title='+title+'&desc='+desc+'&startTime='+startTime+'&endTime='+endTime+'&participants='+participants;
		}
	...
	<body style="height: 100%; margin: 0; padding: 0;">
		...
		<div style="height:48px; width:100%; background:url('<html:rewrite page="/images/dialogtitle.gif"/>')">
			<table width="95%" border="0" cellpadding="6" cellspacing="0">
				<tr>
					<td>
						<font size="2" color="#173891">创建正式会议</font>
					</td>
					<td align="right" >
		...
		<html:form action="/save.do" focus="title" method="post" onsubmit="return validateCreateForm(this);" enctype="multipart/form-data" >
			...
			<table width="100%" align="center" cellspacing="0" cellpadding="8">
				<tr>
					<td align="center">
						<input style="color:#173891;background:url(<html:rewrite page="/images/sbl.gif"/>);border:none;width:60;height:22" type="submit" value="创建" class="blueButton">
