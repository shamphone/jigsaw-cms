...
<html>
	...
	<script type="text/javascript">
		function getUsers() {
			...
			document.location.href='deleteMember.do?groupid='+selectedGroupId;
		}
	</script>	
	...
	<body style="margin: 0; padding: 0;">
		...
		<div style="height:48px; width:100%; background:url('<html:rewrite page="/images/dialogtitle.gif"/>')">
			<table width="95%" border="0" cellpadding="6" cellspacing="0">
				<tr>
					<td>
						<font size="2" color="#173891">删除公共联系人</font>
					</td>
					<td align="right" >
		...
		<html:form style="margin:0px;" action="/removeMember.do">
