...
<html>
	...
	<script type="text/javascript">
		function getNewGroups() {
			...
			document.getElementsByTagName("*").newGroupId.length=0;
			
			document.location.href='moveGroup.do?groupid='+selectedGroupId;
		}
	</script>
	...
	<body style="margin: 0; padding: 0;">
		...
		<div style="height:48px; width:100%; background:url('<html:rewrite page="/images/dialogtitle.gif"/>')">
			<table width="95%" border="0" cellpadding="6" cellspacing="0">
				<tr>
					<td>
						<font size="2" color="#173891">移动公共联系人组</font>
					</td>
					<td align="right" >
		...
		<html:form style="margin:0px; " action="/shiftGroup.do">
		
			<table width="100%" align="center" border="0" cellspacing="0" cellpadding="3" bgcolor="#F9FBFE">
				<tr>
					<td align="right"><font color="#173891">选择要移动的组</font><font color="#FF0000">*</font></td>
					<td>
						<html:select property="groupId" style="width: 156px;" onchange="getNewGroups()">
							<html:optionsCollection name="groups" label="name" value="id" />
						</html:select>
					</td>
				</tr>
				<tr>
					<td align="right"><font color="#173891">选择移动后的组</font><font color="#FF0000">*</font></td>
					<td>
