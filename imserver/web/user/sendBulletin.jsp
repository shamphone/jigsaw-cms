...
<html>
	...
	<body style="height: 100%; margin: 0; padding: 0;">
		...
		<div style="height:48px; width:100%; background:url('<html:rewrite page="/images/dialogtitle.gif"/>')">
			<table width="95%" border="0" cellpadding="6" cellspacing="0">
				<tr>
					<td>
						<font size="2" color="#173891">发送系统公告</font>
					</td>
					<td align="right" >
		...
		<html:form action="/sendBulletin.do" focus="title" method="post" onsubmit="return validateSendBulletinForm(this);">
		
			<table width="100%" align="center" border="0" cellspacing="0" cellpadding="3" bgcolor="#F9FBFE">
				<tr bgcolor="#ECF4FC">
					<td align="right"><font color="#173891">公告标题</font><font color="#FF0000">*</font></td>
					<td align="left"><html:text property="title"/></td>
				</tr>
				<tr bgcolor="#ECF4FC">
					<td align="right"><font color="#173891">公告内容</font><font color="#FF0000">*</font></td>
	...
	<html:javascript formName="/sendBulletin"/>	
</html>
