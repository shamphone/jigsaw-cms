...
<html:html>
	...
	<body style="height: 100%; margin: 0; padding: 0;">
		...
		<div style="height:48px; width:100%; background:url('<html:rewrite page="/images/dialogtitle.gif"/>')">
			<table width="95%" border="0" cellpadding="6" cellspacing="0">
				<tr>
					<td>
						<font size="2" color="#173891">添加公共联系人组</font>
					</td>
					<td align="right" >
		...
		<html:form action="/saveGroup.do" method="post" onsubmit="return validateAddGroupForm(this);">
			...
			<table width="100%" align="center" border="0" cellspacing="0" cellpadding="3" bgcolor="#F9FBFE">
				...
				<tr>
					<td align="right"><font color="#173891">组名称</font><font color="#FF0000">*</font></td>
	...
	<html:javascript formName="/saveGroup"/>
