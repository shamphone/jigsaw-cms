...
import com.fulong.lyvc.message.ApplyDesktop;
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class ApplyDesktopHandler extends DesktopBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((ApplyDesktop) message).receiverId, message);
