...
import com.fulong.lyvc.message.ApplyControlDesktop;

/**
 * ApplyControlDesktopHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class ApplyControlDesktopHandler extends DesktopBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((ApplyControlDesktop) message).receiverId, message);
	}
