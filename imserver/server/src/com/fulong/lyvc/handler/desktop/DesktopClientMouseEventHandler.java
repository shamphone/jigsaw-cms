...
import com.fulong.lyvc.message.DesktopClientMouseEvent;



/**
 * DesktopClientMouseEventHandler
 *
 * ��Ԧ��Ƶ����ϵͳ v3.0
 *
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class DesktopClientMouseEventHandler extends DesktopBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
        ...
        sendMessage(((DesktopClientMouseEvent)message).receiverId, message);
	}
