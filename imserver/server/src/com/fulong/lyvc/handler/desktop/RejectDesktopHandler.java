...
import com.fulong.lyvc.message.RejectDesktop;

/**
 * RejectDesktopHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class RejectDesktopHandler extends DesktopBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((RejectDesktop) message).receiverId, message);
	}
