...
import com.fulong.lyvc.message.RemoveGroup;
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class RemoveGroupHandler extends ContactBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		this.getConferenceManager().delete(this.getConferenceManager().getGroup(((RemoveGroup)message).groupId));
	}
