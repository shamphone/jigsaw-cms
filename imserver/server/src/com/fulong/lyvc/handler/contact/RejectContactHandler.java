...
import com.fulong.lyvc.message.RejectContact;
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class RejectContactHandler extends ContactBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((RejectContact) message).receiverId, message);
	}
