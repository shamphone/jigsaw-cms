...
import com.fulong.lyvc.message.CameraZoomIn;
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class CameraZoomInHandler extends YuntaiBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((CameraZoomIn) message).receiverId, message);
	}
}
