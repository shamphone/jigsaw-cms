...
import com.fulong.lyvc.message.CameraMoveRight;

/**
 * CameraMoveRightHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class CameraMoveRightHandler extends YuntaiBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((CameraMoveRight) message).receiverId, message);
	}
