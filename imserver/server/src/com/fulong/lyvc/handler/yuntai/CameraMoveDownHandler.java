...
import com.fulong.lyvc.message.CameraMoveDown;

/**
 * CameraMoveDownHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class CameraMoveDownHandler extends YuntaiBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((CameraMoveDown) message).receiverId, message);
	}
