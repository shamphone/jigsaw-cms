...
import com.fulong.lyvc.message.KickUserFromConference;



/**
 * KickUserFromConferenceHandler
 *
 * ��Ԧ��Ƶ����ϵͳ v3.0
 *
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class KickUserFromConferenceHandler extends ConferenceBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		this.sendMessage(((KickUserFromConference)message).confUserId, message);
	}
