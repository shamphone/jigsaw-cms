...
import com.fulong.lyvc.message.StartMarkWindow;

/**
 * StartMarkWindowHandler
 *
 * ��Ԧ��Ƶ����ϵͳ v3.0
 *
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class StartMarkWindowHandler extends ConferenceBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		this.sendMessage(((StartMarkWindow)message).receiverId, message);
	}
