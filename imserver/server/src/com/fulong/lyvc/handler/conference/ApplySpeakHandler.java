...
import com.fulong.lyvc.message.ApplySpeak;
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class ApplySpeakHandler extends ConferenceBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		this.sendMessage(((ApplySpeak)message).receiverId, message);
	}
