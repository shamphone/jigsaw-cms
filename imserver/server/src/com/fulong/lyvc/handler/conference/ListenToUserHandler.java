...
import com.fulong.lyvc.message.ListenToUser;
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class ListenToUserHandler extends ConferenceBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message)	throws Exception {
	    ...
	    this.sendMessage(((ListenToUser)message).receiverId, message);
	}
