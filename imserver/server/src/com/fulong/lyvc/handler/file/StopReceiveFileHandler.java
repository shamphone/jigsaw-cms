...
import com.fulong.lyvc.message.StopReceiveFile;

/**
 * StopReceiveFileHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class StopReceiveFileHandler extends FileBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((StopReceiveFile) message).receiverId, message);
	}
