...
import com.fulong.lyvc.message.SendFileData;
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class SendFileDataHandler extends FileBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((SendFileData) message).receiverId, message);
	}
