...
import com.fulong.lyvc.message.StopSendFile;
 ...
 * ����޸�ʱ�䣺2009-3-13
 */
public class StopSendFileHandler extends FileBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
        ...
        sendMessage(((StopSendFile)message).receiverId, message);
	}
