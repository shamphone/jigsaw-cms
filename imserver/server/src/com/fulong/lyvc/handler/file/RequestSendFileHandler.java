...
import com.fulong.lyvc.message.RequestSendFile;

/**
 * RequestSendFileHandler
 * 
 * ��Ԧ��Ƶ����ϵͳ v3.0
 * 
 * ��Ȩ���У������пƸ���������ɷ����޹�˾ 2009
 ...
 *         ����޸�ʱ�䣺2009-3-13
 */
public class RequestSendFileHandler extends FileBaseHandler {
	...
	public void execute(TCPChannel channel, TCPMessage message) throws Exception {
		...
		sendMessage(((RequestSendFile) message).receiverId, message);
	}
