...
public class InstantConferenceModelId extends BaseMessage{

	public static final int id = 154;

	public String instantConferenceModelId;
	...
	public String toXML() {
		...
		xml.append("<instantConferenceModelId>" + this.instantConferenceModelId + "</instantConferenceModelId>");
		xml.append("</lyvcmessage>");
	...
	public void fromXML(String xmlString) throws MessageFormatException {
		...
		this.instantConferenceModelId = tagContent;
	}
