...
public class KickUserFromConference extends BaseMessage{
	...
	public String toXML() {
		...
		xml.append("<confUserId>" + this.confUserId + "</confUserId>");
		xml.append("<confId>" + this.confId + "</confId>");
		xml.append("</lyvcmessage>");
