...
import com.fulong.process.form.NormalActivityForm;
...
public class SaveAction extends ProcessBaseAction {
	...
	protected ActionForward doPerform(ActionMapping mapping, ActionForm form,
			...
			throws Exception {
		NormalActivityForm activityForm = (NormalActivityForm) form;
		...
		//若activity不存在，则为创建操作
		if (activity == null) {
				activity = processDefinition.createActivity(null,activityName);
		}
