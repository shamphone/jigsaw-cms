...
public class GetCompontentAction extends ProcessBaseAction {
	...
	protected ActionForward doPerform(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("transitions", processDefinition.getTransitions());
