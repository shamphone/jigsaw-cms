 ...
 *
 */
public class ImportAction extends DefinitionBaseAction {
...
class EventListener implements ImporterEventListener {
	private ActionMessages messages;
	public EventListener(ActionMessages messages){
