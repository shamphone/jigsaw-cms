...
<html>
  ...
  <body>
    <table border=0 cellpadding=0 cellspacing=0 align=center>
      <html:form action="/saveScript.do" method="post"  >
        <html:hidden property="path"/>
        <tr>
          <td>
            <fieldset>
              <legend>脚本文件属性</legend>
              <table border=0 cellpadding=5 cellspacing=0>
                <tr>
                  <td>文件名称</td>
                  <td>
                    <html:text property="scriptID"/>
                    <div class="formTips">请填写一个与已有脚本文件不重复的文件名称。不要包含~！·#$%^&amp;*()等特殊字符。</div>
                  </td>
                </tr>
    ...
    <%--<html:javascript formName="scriptForm" bundle="script"/>--%>
