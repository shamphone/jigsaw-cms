...
FCKConfig.Plugins.Add( 'js','en,zh-cn') ;
...
FCKConfig.ToolbarSets["Default"] = [
	['NewObject','SaveChannel','PublishChannel','RestoreChannel','DeleteChannel','MoveChannel','Checkout','PageSize','ImportHTML','EditChannel'],
     '/',
	['Cut','Copy','Paste','PasteText'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','Image']
] ;
...
FCKConfig.LinkBrowserURL = Globals.contextPath + '/site/resource/index.do?templateID='+oTemplate.ID;
FCKConfig.LinkBrowserWindowWidth	=  780  ;	 
FCKConfig.LinkBrowserWindowHeight	=  600  ;	

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = Globals.contextPath +  '/site/resource/index.do?templateID='+oTemplate.ID;
