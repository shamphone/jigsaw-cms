...
<%----%>
        ...
        LoadScript( 'tableXrepeaterEditor.js') ;
	...
	<script type="text/javascript">
        ...
        function saveSource(){
	    	...
	    	var url= modulePath+ '/channel/saveSourceTable.do?clip=true';
    ...
    <table cellpadding="0" cellspacing="0" style="height:100%; table-layout:fixed; width:expression(document.body.clientWidth)">
      ...
      <button type="button" onclick="saveSource()" style="margin-right:10px">确定</button>
