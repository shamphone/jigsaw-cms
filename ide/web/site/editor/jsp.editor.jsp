...
*/
	...
	<script type="text/javascript">
        ...
        LoadCss( "<html:rewrite page='/jsp.editor.css' module='/site/editor'/>" ) ;
	...
	<script type="text/javascript">
        ...
        <body><a id="oWevDAV" href = '<fulong:rewriteURL page="/webdav/" module=""/><bean:write name='channel' property='siteTemplate.name' ignore='true'/>' folder = '<fulong:rewriteURL page="/webdav/" module=""/><bean:write name='channel' property='siteTemplate.name' ignore='true'/>' target = "_blank" style="behavior: url(#default#AnchorClick);"></a>
            <table width="100%" cellpadding="0" cellspacing="0" style="height: 100%; table-layout: fixed">
                <tr id="xToolbarRow" style="display: none">
                    <td id="xToolbarSpace" style="overflow: hidden">
                        ...
                        <tr>
                            <td id="xEditingArea" valign="top" style="height:100%;width:100%"></td>
                        </tr>
                    </table>
                  </body>
            </html>
