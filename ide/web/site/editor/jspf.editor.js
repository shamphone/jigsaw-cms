...
FCKConfig.Plugins.Add( 'jspf','en,zh-cn') ;
...
FCKConfig.ToolbarSets["Default"] = [
	['NewObject','SaveChannel','Preview','PublishChannel','RestoreChannel','DeleteChannel','CopyChannel','MoveChannel','Checkout','PageSize','ImportHTML','EditChannel'],
     '/',
...
FCKConfig.LinkBrowserURL = Globals.contextPath + "/site/resource/index.jsp?template="+oTemplate.ID;
FCKConfig.LinkBrowserWindowWidth	=  780  ;	 
FCKConfig.LinkBrowserWindowHeight	=  600  ;	

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = Globals.contextPath + "/site/resource/index.jsp?template="+oTemplate.ID;
FCKConfig.ImageBrowserWindowWidth  =  780  ;	
FCKConfig.ImageBrowserWindowHeight =  600   ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = Globals.contextPath + "/site/resource/index.jsp?template="+oTemplate.ID;
...
FCKConfig.MediaBrowserURL = Globals.contextPath + "/site/resource/index.do?templateID="+oTemplate.ID;
