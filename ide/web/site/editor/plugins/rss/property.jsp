...
<tiles:insert definition="dialog_frame">
  <tiles:put name="title">修改RSS页面</tiles:put>
  <tiles:put name="javascript">
	...
	<script language="Javascript" type="text/Javascript" src="<html:rewrite module="/site" page="/rss/rss.js"/>"></script>
	<script language="Javascript" type="text/Javascript" src="<html:rewrite module="/site" page="/editor/plugins/rss/property.js"/>"></script>
  ...
  <tiles:put name="dialog">
	...
	<tr>
		...
		<td valign="top">
		<fieldset>
      <div style="color:red; margin-left:6px"></div>
      <table border="0" style="margin-top: 10px;" cellpadding="1" cellspacing="1" align="center" width="100%">
        <tr>
          ...
          <td>
            <input id="name" disabled="disabled" type="text" onchange="validateChannel(this.form)" style="IME-MODE: disabled" name="name" maxlength="32" title="系统中的ID及文件名称，全模板唯一。"/>
          </td>
        </tr>
        <tr>
       	 	<td>显示名称<span style="color: red;">&nbsp;*</span></td>
	        <td>
	           <input id="displayName" type="text" name="displayName" title="能响应该频道的网站栏目URL"/>
	        </td>
        </tr>
        <tr>
          <td>频道语言<span style="color: red;">&nbsp;*</span></td>
          <td>
          	 <select id="language" style="width: 205px;" name="language" title="频道所使用的语言">
        ...
        <tr>
        	<td>频道URL<span style="color: red;">&nbsp;*</span></td>
	          <td>
	            <input id="link" type="text" name="link" title="能响应该频道的网站栏目URL"/>
	          </td>
	        <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td >
            <textarea id="description" name="description" rows="4" cols="23" title="对该频道的描述信息"></textarea>
          </td>
        </tr>
        <!-- 
        <tr>
      ...
      <tr>
         ...
         <tr>
          <td>文档URL</td>
          <td>
            <input id="docs" type="text" name="docs" title="指向rss格式文档的url地址"/>
          </td>
        </tr>
        <tr>
          <td>缓存时间</td>
          <td>
             <input id="ttl" type="text" name="ttl" title="cache的有效保存时间。"/>
          </td>
        </tr>
        <tr>
        	<td>版权声明</td>
	        <td>
	        	<input id="copyright" type="text" name="copyright" title="版权声明"/>
	        </td>
        </tr>
      </table>
      </fieldset>
      ...
      <table border="0" cellpadding="2" cellspacing="2" align="left" width="100%" id="styleTable">
		...
		<tr>
			...
			<td>
				<input id="itemNum" type="text" name="itemNum">
			</td>
		</tr>
		<tr>
			<td>标题<span style="color: red;">&nbsp;*</span></td>
			<td>
				<input id="itemTitle" type="hidden" name="itemTitle">
				<input id="itemTitleName" type="text" readonly="readonly" name="itemTitleName" id="title">
		...
		<tr>
			...
			<td>
				<input id="itemDescription" type="hidden" name="itemDescription">
				<input id="itemDescriptionName" type="text" readonly="readonly" name="itemDescriptionName">
                ...
                <tr>
                  <td  colspan="2" class="formComponent">
                    ...
                    <div style="margin-top:5px;" align="right">
                    	<button type="button" class="commonbut" onclick="newFilter_Search(form.elements['definitionID'],form.elements['filterPatterns'],'')">添 加</button>
