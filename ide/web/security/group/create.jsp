...
<html:hidden  property="nodeID" />
	...
	<button id="btnCancel" type="button" onclick="window.parent.close();" class="commonbut">取消</button>
	</div>
</html:form>
...
function checkGroupname(oform){
	...
	var nodeID = oform.nodeID.value;
			...
			var urlTemp = '<html:rewrite module="/security/group" page="/validateUnique.do"/>?value=' + encodeURI(groupname) + '&property=title&parentNodeID='+ nodeID;
