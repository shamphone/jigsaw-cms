...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div style="margin-top:20px">
      <html:form action="/doSearchOrg.do" method="POST">
        ...
        <logic:present name="principals">
          <logic:equal value="0" name="principals" property="size">
            ...
            <div class="operation">
              <button type="button" onclick="window.close()" class="commonbut" id="back">确定</button>
            </div>
          </logic:equal>
            ...
            <div style="height:370px;overflow-y: scroll;">
              <table id="table1" width="96%" border="1" cellpadding="0" cellspacing="0" class="tableClass">
                <logic:iterate id="prin" name="principals">
                  ...
                  <td><bean:write name="prin" property="commonname" ignore="true"/></td>
                </tr>
              </logic:iterate>
            </table>
          </div>
      ...
      <logic:notPresent name="principals">
        <div class="operation">
          <button type="button" onclick="window.close()" class="commonbut" id="back">取消</button>
        </div>
      </logic:notPresent>
  ...
  <script language="JavaScript" type="text/Javascript">
    ...
    function ok(submitter){
      ...
      if(GetRadioObject(item)!=null){
        ...
        ret.commonname = table1.rows[parseInt(No)].cells[1].innerText;
