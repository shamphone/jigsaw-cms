...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div style="margin-top:20px">
      <html:form action="/doSearchGroup.do" method="POST">
        <!--table width="100%" border="1" cellpadding="0" cellspacing="0" class="sheetClass">
          <tr>
            <th scope="row">组名称</th>
            <td>
            ...
            <div style="height:370px;overflow-y: scroll;">
              <table id="table1" width="96%" border="1" cellpadding="0" cellspacing="0" class="tableClass">
                <logic:iterate id="prin" name="principals">
                  ...
                  <td><bean:write name="prin" property="description" ignore="true"/></td>
                </tr>
              </logic:iterate>
            </table>
          </div>
