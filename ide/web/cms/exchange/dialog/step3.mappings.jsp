...
<script language="Javascript" type="text/Javascript">
	...
	config.mapping = "auto";
	config.mappingName = "自动映射";		
	var nextURL = "last.name.jsp";
	function onAuto(){ 
		config.mapping = "auto";
		config.mappingName = "自动映射";		
	}
	function onCreate(){
		nextURL = "step4.create.jsp";	
	}
	function onExist(){
		nextURL = "step4.exist.jsp";		
	}
	function onPrev(){
		window.location = "step2.locale.jsp";
	}
	function onNext(){
...
<table width="100%" cellpadding="2" cellspacing="0" border="0">
	<tr>
		<td><input checked="checked" type="radio" value="auto" id="auto" name="mapping" onclick="onAuto()"/><label for="auto">自动映射</label> </td>
	</tr>
	<tr>
		<td><input type="radio" value="exist" id="create" name="mapping"  onclick="onCreate()"/><label for="create">新映射</label></td>
	</tr>
	<tr>
		<td><input type="radio" value="exist" id="exist" name="mapping" onclick="onExist()"/><label for="exist">使用现有映射</label> </td>
	</tr>
	<tr>
	...
	<div class="operation">
		<button onclick="onPrev()" id="btnPrev" >上一步</button>		
		<button onclick="onNext()" id="btnNext">下一步</button>
