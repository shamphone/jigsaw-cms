...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="buttonface" style="border: 0px; margin: 0px; padding: 0px;">
				...
				<tr>
					...
					<table align="center" cellspacing="2" cellspadding="2" border="0" width="100%">
						<tr valign="top">
							...
							<td>
								<div><button type="button"onclick="newFilter(this.form('filters'))">添加</button></div>
								<div><button type="button"onclick="delFilterColumns(this.form('filters'))";>删除</button></div>
							</td>
						</tr>
					</table>
					</fieldset>
						...
						<table align="center" cellspacing="2" cellspadding="2" border="0" width="100%">
							<tr valign="top">
								...
								<td>
									...
									<!-- div><button type="button"onclick="editColumns()">添加</button></div -->
									<!--div><button type="button"onclick="delDisplayColumns()">删除</button></div-->
								</td>
							</tr>
						</table>
					</fieldset>
