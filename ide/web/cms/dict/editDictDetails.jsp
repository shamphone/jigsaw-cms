...
<tiles:insert definition="content_frame">
  <tiles:put name="title">修改内容分类项</tiles:put>
  <tiles:put name="body">
    <html:form action="updateDictDetails.do" enctype="multipart/form-data" method="POST">
      <input type="hidden" name="dictId" value="<bean:write name="entry" property="ID"/>" />
    ...
    <cms:nodeValidator propertyDefinitions="properties" formName="dictDetailsForm">
