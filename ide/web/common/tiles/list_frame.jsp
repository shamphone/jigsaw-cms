...
<%@page errorPage="/common/tiles/error_noSuchElement.jsp" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="oTabbar"><tiles:getAsString name="tabbar" ignore="true"/></div>
    <div id="oListPanel">
    ...
    <div id="oToolbar">
      ...
      <span id="oToolPanel">
        <tiles:getAsString name="toolbar" ignore="true"/>
        <span style="height:20px"><button class="btnMaximize" onclick="ListFrame.ReSize(this)"/></span>
      </span>
    </div>
    </body>
</html>
