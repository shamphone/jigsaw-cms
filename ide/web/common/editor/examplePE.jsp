...
<body>
  <form action="#">
    <input type="hidden" name="richtext" value="&lt;font class=&quot;font&quot;&gt;　　温家宝在全国城镇居民基本医疗保险试点工作座谈会上指出&lt;p&gt;　　高度重视 精心组织
		...
		&lt;/font&gt;"/>
    <iframe src="portletUsedEditor.jsp?InstanceName=richtext" width="960" height="500" frameborder="0" marginheight="0" marginwidth="0" scrolling="no">
    </iframe>
  </form>
</body>
</html>
