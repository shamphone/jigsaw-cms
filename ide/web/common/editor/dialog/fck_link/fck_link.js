...
function ChooseChannel() {
	var templateId = oEditor.oTemplate.ID;
    var ret = SiteDialog.selectChannel(templateId, '', true, false, FCKLang.DlgChooseChannelTitle, ["clip"]);
    if(ret) {
    	GetE("cmbLinkProtocol").value = "";
    	GetE("txtUrl").value = ret.path;
    }
}