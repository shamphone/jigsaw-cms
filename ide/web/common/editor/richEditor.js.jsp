...
FCKConfig.ContextPath = "<%= request.getContextPath() %>";
FCKConfig.BasePath=FCKConfig.ContextPath+'/common/editor/';
FCKConfig.EditorPath=FCKConfig.ContextPath+'/common/editor/';
...
FCKConfig.Plugins.Add( 'fck_media','en,zh-cn' ) ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord','-','Find','Replace','SpellCheck'],
	['Undo','Redo','-','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','StrikeThrough','Superscript','Subscript'],['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['OrderedList','UnorderedList','Outdent','Indent'],['TextColor','BGColor','Bgpic'],['Image','Flash','Media'],
        ['Hrule','Marquee'],['Link','Unlink','Anchor'],['Table'],['ImportWord'],['Paragraph'],
        ['SpecialChar','Smiley','Wordart','CurrentDate','CurrentTime'],['PageBreak','Print'],
	['Blockquote']
...
FCKConfig.CoreStyles =
{
        ...
        'LineHeight' :
	{
		...
		Overrides	: [ { Element : 'font', Attributes : { 'line-height' : null } } ]
	},
        'LetterSpacing' :
	{
		Element		: 'span',
		Styles		: { 'letter-spacing' : '#("letterSpacing","LetterSpacing")' },
		Overrides	: [ { Element : 'font', Attributes : { 'letter-spacing' : null } } ]
	},
...
FCKConfig.LinkBrowserURL = '<html:rewrite module="/cms/resource" page="/browse.do"/>' ;
FCKConfig.LinkBrowserWindowWidth	= FCKConfig.ScreenWidth * 0.7 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= FCKConfig.ScreenHeight * 0.7 ;	// 70%

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = '<html:rewrite module="/cms/resource" page="/browse.do"/>?resourceType=image' ;
FCKConfig.ImageBrowserType = 'DB' ;
FCKConfig.ImageBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;		// 70% ;
FCKConfig.ImageBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = '<html:rewrite module="/cms/resource" page="/browse.do"/>?resourceType=flash';
FCKConfig.FlashBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.7 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = FCKConfig.ScreenHeight * 0.7 ;	//70% ;

FCKConfig.LinkUpload = false ;
FCKConfig.LinkUploadURL = '<html:rewrite module="/cms/resource" page="/updateResource.jsp"/>';
...
FCKConfig.MediaBrowserURL = '<html:rewrite module="/cms/resource" page="/browse.do"/>?resourceType=media' ;
